                      ...
                      <div class="w-full md:w-1/3 bg-white grid place-items-center">
                        ...
                        <div class="w-full md:w-2/3 bg-white flex flex-col space-y-2 p-3">
                          <div class="flex justify-between item-center">
                            <p class="text-gray-500 font-medium hidden md:block">Party Category</p>
                          ...
                          <h3 class="font-black text-gray-800 md:text-3xl text-xl">{party.name}</h3>
                          <p class="md:text-lg text-gray-500 text-base">{party.description}</p>
